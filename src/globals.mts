...
// export const FRONTEND_URL = 'http://localhost:4000'; // Use https://portrait.so for production
export const API_URL = 'http://localhost:3001/api/v2'; // Use https://api.portrait.so for production
export const FRONTEND_URL = 'https://portrait.so';
// export const API_URL = 'https://api.portrait.so/api/v2';
